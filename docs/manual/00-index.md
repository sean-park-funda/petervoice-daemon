...
웹 UI(채팅/음성)로 메시지를 보내면 Claude Code CLI 기반 AI 비서(담당자)가 프로젝트 작업을 수행하는 플랫폼.
실행 위치는 두 가지 — 유저 Mac/PC의 로컬 데몬(03장) 또는 피터보이스 클라우드 공용 데몬(34장, 2026-07-23 이후 가입 기본값).
...
이 매뉴얼은 2026-02-16 ~ 2026-04-14 기간의 실제 개발 대화를 분석해 처음 작성했고, 이후 기능이 추가될 때마다 장을 덧붙여 갱신하고 있습니다 (예: 34장 클라우드 데몬 2026-07-23, 35장 원격 로그인 인계 2026-08-06, 36장 브라우저 자동화 동시 사용 2026-08-20, 37장 데몬 자가진단 2026-08-25). **각 장의 서술 시점은 그 장을 따르세요.**
