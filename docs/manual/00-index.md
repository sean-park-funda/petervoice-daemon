...
이 매뉴얼은 2026-02-16 ~ 2026-04-14 기간의 실제 개발 대화를 분석해 처음 작성했고, 이후 기능이 추가될 때마다 장을 덧붙여 갱신하고 있습니다 (예: 34장 클라우드 데몬 2026-07-23, 35장 원격 로그인 인계 2026-08-06, 36장 브라우저 자동화 동시 사용 2026-08-20). **각 장의 서술 시점은 그 장을 따르세요.**
